...
public class C02_cssSelector {
    public static void main(String[] args) throws InterruptedException {
        ...
        */
        ...
        WebElement deleteButton = driver.findElement(By.cssSelector("button[onclick='deleteElement()']")); // classla da alabiliriz.
        System.out.println(deleteButton.isDisplayed());
        /* if'le de yapabiliriz.
        ...
        //Click : Buton ve linklerin üzerine gelip tıklamaya denir.
